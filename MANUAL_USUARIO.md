...
TechStore es una aplicación móvil Android que permite gestionar una tienda de productos tecnológicos. La aplicación incluye funcionalidades completas de CRUD (Crear, Leer, Actualizar, Eliminar) para usuarios y productos, así como gestión de carrito de compras, geolocalización y captura de imágenes.
...
- ✅ Almacenamiento de imágenes en dispositivo
...
- Cámara (opcional, para captura de imágenes)
- GPS (opcional, para geolocalización)

### Permisos Requeridos
La aplicación solicitará los siguientes permisos:
- **Cámara:** Para capturar imágenes de productos
...
- Etiqueta: [Campos: 1-Nombre, 2-Descripción, 3-Precio, 4-Categoría, 5-Stock, 6-Imagen]
   ...
   - **Imagen:** Toca para capturar o seleccionar imagen

**IMAGEN 23: Captura de Imagen con Cámara**
- Descripción: Captura mostrando opciones "Tomar Foto" y "Seleccionar de Galería"
- Etiqueta: [Diálogo de selección de imagen]

3. Para agregar imagen:
   - Toca el área de imagen
   - Selecciona **"Tomar Foto"** para usar la cámara
   - O selecciona **"Seleccionar de Galería"** para elegir una imagen existente

**IMAGEN 24: Vista Previa de Imagen**
- Descripción: Captura mostrando imagen capturada/seleccionada
- Etiqueta: [Vista previa de la imagen del producto]

4. Toca **"Guardar"** para crear el producto

**IMAGEN 25: Producto Creado Exitosamente**
- Descripción: Captura mostrando el nuevo producto en la lista
- Etiqueta: [Producto recién creado visible en la lista]

### 6.4. Editar Producto

**IMAGEN 26: Botón Editar en Item de Producto**
...
**IMAGEN 27: Formulario de Edición**
...
4. Puedes actualizar la imagen si es necesario
5. Toca **"Guardar Cambios"**

**IMAGEN 28: Producto Actualizado**
...
**IMAGEN 29: Botón Eliminar en Item de Producto**
...
**IMAGEN 30: Diálogo de Confirmación de Eliminación**
- Descripción: Captura del diálogo "¿Eliminar este producto?"
- Etiqueta: [Botones "Eliminar" y "Cancelar" señalados]

3. Confirma la eliminación
4. El producto será eliminado de la base de datos y su imagen del almacenamiento

**IMAGEN 31: Producto Eliminado**
...
**IMAGEN 32: Agregar al Carrito desde Detalle**
...
**IMAGEN 36: Controles de Cantidad**
...
**IMAGEN 43: Diálogo de Confirmación de Compra**
...
**IMAGEN 45: Opción Mi Ubicación en Perfil**
...
**IMAGEN 46: Solicitud de Permisos de Ubicación**
...
**IMAGEN 48: Opción Ubicaciones de Tiendas**
...
**IMAGEN 50: Detalle de Tienda en Mapa**
...
- Ve a Configuración > Aplicaciones > TechStore > Permisos
